function south = move_south(actions_matrix,row,i,j,value_matrix_i,prob_d1,prob_d2,d,reward,discount_rate)
if d == 1
    columns1 = [4,9,10];
    columns2 = [];
else
...
if d == 1
south = reward + discount_rate * (prob_d1(2) * value_temp_matrix(1) + prob_d1(1) * value_temp_matrix(2) + prob_d1(3) * value_temp_matrix(3));
else
south = reward + discount_rate * (prob_d2(1) * value_temp_matrix(2) + prob_d2(2) * value_temp_matrix(1) + prob_d2(3) * value_temp_matrix(3) + prob_d2(4) * value_temp_matrix(4));
end
end